  ...
  return (
    <section className="py-16 md:py-24 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-blue-600 via-blue-600 to-teal-500 rounded-3xl p-8 sm:p-12 md:p-16 text-white text-center shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="#products"
                className="w-full sm:w-auto px-8 py-3.5 bg-white text-blue-600 hover:bg-slate-100 font-bold text-sm rounded-full transition-all shadow-md flex items-center justify-center gap-2 min-h-[48px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
              >
              ...
              <Link
                href="/suppliers"
                className="w-full sm:w-auto px-8 py-3.5 bg-transparent hover:bg-white/10 text-white font-bold text-sm rounded-full border border-white/30 transition-all flex items-center justify-center min-h-[48px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
              >
                Verified Suppliers
              </Link>
            </div>
