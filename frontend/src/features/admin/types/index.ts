...
// ---------------------------------------------------------------------------
// 3. Product Moderation Types
// ---------------------------------------------------------------------------

export type ProductAvailability = "AVAILABLE" | "OUT_OF_STOCK" | "HIDDEN" | "DISCONTINUED";
...
export interface AdminProductSupplierResponse {
  ...
  supplierUserStatus?: UserStatus | null;
  purity?: string | null;
  grade?: string | null;
  moqKg?: number | null;
  packaging?: string | null;
...
// ---------------------------------------------------------------------------
// 4. Transaction Oversight Types (RFQs & Purchase Orders)
// ---------------------------------------------------------------------------
