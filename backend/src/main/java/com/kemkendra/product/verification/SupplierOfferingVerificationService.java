...
public class SupplierOfferingVerificationService {
    ...
    private final com.kemkendra.product.CatalogImageService catalogImageService;
    ...
    public SupplierOfferingVerificationService(
            ...
            com.kemkendra.product.CatalogImageService catalogImageService) {
    ...
    public SupplierOfferingGovernanceWorkspaceDto getOfferingVerificationDetails(UUID offeringId) {
        ...
        List<com.kemkendra.product.dto.CatalogImageResponse> images = catalogImageService.getOfferingImages(offeringId);
        List<com.kemkendra.document.DocumentResponse> documents = documentRepository
                .findByOwnerTypeAndOwnerId(com.kemkendra.document.DocumentOwnerType.SUPPLIER_OFFERING, offeringId)
                .stream()
