...
public class MasterProduct {
    ...
    private com.kemkendra.identity.User deactivatedBy;
    ...
    public com.kemkendra.identity.User getDeactivatedBy() {
        return deactivatedBy;
    }

    public void setDeactivatedBy(com.kemkendra.identity.User deactivatedBy) {
