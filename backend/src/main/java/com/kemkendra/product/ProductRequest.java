...
public class ProductRequest {
    ...
    private com.kemkendra.identity.User reviewedBy;
    ...
    public com.kemkendra.identity.User getReviewedBy() {
        return reviewedBy;
    }

    public void setReviewedBy(com.kemkendra.identity.User reviewedBy) {
