...
public class ProductRequestService {
    ...
    public ProductRequestResponse respondProductInformation(UUID requestId, com.kemkendra.product.dto.RespondProductInfoPayload payload, Authentication authentication) {
        User user = resolveUser(authentication);
        Supplier supplier = identityResolver.resolveOperationalSupplier(user);
