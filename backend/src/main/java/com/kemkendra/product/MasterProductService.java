...
import com.kemkendra.product.dto.AddSynonymPayload;
...
import com.kemkendra.product.dto.ProductSynonymResponse;
...
public class MasterProductService {
     ...
     */
    @Transactional(readOnly = true)
    public Page<MasterProductResponse> searchActiveMasterProductsWithCriteria(com.kemkendra.product.dto.MasterProductSearchCriteria criteria) {
    ...
    public ProductSynonymResponse suggestSupplierSynonym(UUID masterProductId, AddSynonymPayload payload, Authentication auth) {
        ...
        SynonymSource source = user.getRole() == com.kemkendra.identity.UserRole.ADMIN ? SynonymSource.OFFICIAL : SynonymSource.SUPPLIER;
        SynonymStatus status = user.getRole() == com.kemkendra.identity.UserRole.ADMIN ? SynonymStatus.APPROVED : SynonymStatus.PENDING;
