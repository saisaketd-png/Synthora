...
public class SitemapController {
    ...
    public String getSitemapXml() {
        ...
        // Static routes
        xml.append("  <url><loc>https://kemkendra.com/</loc><changefreq>daily</changefreq><priority>1.0</priority></url>\n");
        xml.append("  <url><loc>https://kemkendra.com/products</loc><changefreq>daily</changefreq><priority>0.9</priority></url>\n");
        xml.append("  <url><loc>https://kemkendra.com/categories</loc><changefreq>weekly</changefreq><priority>0.8</priority></url>\n");
        ...
        for (MasterProduct mp : activeProducts) {
            ...
            if (count > 0) {
                xml.append("  <url>\n");
                xml.append("    <loc>https://kemkendra.com/products/").append(mp.getMasterProductCode()).append("</loc>\n");
