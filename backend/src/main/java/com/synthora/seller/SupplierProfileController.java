...
public class SupplierProfileController {
    ...
    public ResponseEntity<com.synthora.product.dto.SupplierPerformanceResponse> getMyPerformance(Authentication auth) {
        User user = resolveAuthenticatedUser(auth);
        Supplier supplier = identityResolver.resolveOperationalSupplier(user);
    ...
    public ResponseEntity<SupplierProfileResponse> submitVerification(Authentication auth) {
        ...
        notificationService.createNotification(
                ...
                "Your company verification request has been submitted for Synthora marketplace review.",
