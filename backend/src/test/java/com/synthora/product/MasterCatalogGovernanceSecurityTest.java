...
public class MasterCatalogGovernanceSecurityTest {
    ...
    public void setUp() {
        ...
        adminUser.setEmail("admin_cat_" + suffix + "@synthora.com");
        ...
        supplierUser.setEmail("prop_sup_" + suffix + "@synthora.com");
        ...
        buyerUser.setEmail("buyer_cat_" + suffix + "@synthora.com");
    ...
    public void test03_AdminApproveRequestCreatesMasterProductAndNotifiesSupplier() {
        ...
        assertFalse(auditLogRepository.findByTargetTypeAndTargetIdOrderByCreatedAtDesc(
                com.synthora.admin.audit.AuditTargetType.PRODUCT_REQUEST,
                req.id().toString()
        ).isEmpty());
    }
