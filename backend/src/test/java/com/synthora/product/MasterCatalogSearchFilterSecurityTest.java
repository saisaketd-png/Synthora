...
public class MasterCatalogSearchFilterSecurityTest {
    ...
    public void setUp() {
        ...
        supplierUser.setEmail("sup_filter_" + suffix + "@synthora.com");
        ...
        buyerUser.setEmail("buyer_filter_" + suffix + "@synthora.com");
    ...
    @Autowired
    private com.synthora.product.apis.AdminMasterCatalogController adminMasterCatalogController;
