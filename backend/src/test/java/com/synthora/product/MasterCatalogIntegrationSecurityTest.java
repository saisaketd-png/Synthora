...
public class MasterCatalogIntegrationSecurityTest {
    ...
    public void setUp() {
        ...
        adminUser.setEmail("admin_integ_" + suffix + "@synthora.com");
        ...
        supplierUserA.setEmail("sup_a_integ_" + suffix + "@synthora.com");
        ...
        supplierUserB.setEmail("sup_b_integ_" + suffix + "@synthora.com");
        ...
        buyerUser.setEmail("buyer_integ_" + suffix + "@synthora.com");
