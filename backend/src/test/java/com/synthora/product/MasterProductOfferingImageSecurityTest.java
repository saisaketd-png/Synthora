...
public class MasterProductOfferingImageSecurityTest {
    ...
    public void setUp() {
        ...
        adminUser.setEmail("admin_img_" + suffix + "@synthora.com");
        ...
        supplierUserA.setEmail("sup_a_img_" + suffix + "@synthora.com");
        ...
        supplierUserB.setEmail("sup_b_img_" + suffix + "@synthora.com");
        ...
        buyerUser.setEmail("buyer_img_" + suffix + "@synthora.com");
