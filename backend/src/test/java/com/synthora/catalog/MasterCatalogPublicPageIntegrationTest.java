...
public class MasterCatalogPublicPageIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        jdbcTemplate.execute("UPDATE rfqs SET accepted_quotation_id = NULL; DELETE FROM governance_audit_logs; DELETE FROM audit_logs; DELETE FROM notifications; DELETE FROM documents; DELETE FROM shipments; DELETE FROM purchase_orders; DELETE FROM quotations; DELETE FROM rfqs; DELETE FROM supplier_offerings; DELETE FROM product_master_mappings; DELETE FROM master_products; DELETE FROM product_suppliers; DELETE FROM products; DELETE FROM seller_profiles; DELETE FROM suppliers; DELETE FROM users;");

        // Admin
        adminUser = new User(UUID.randomUUID(), "Admin", "admin_pub15@synthora.com", "9900112233", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        // Supplier A
        supplierUserA = new User(UUID.randomUUID(), "Supplier A User", "supa_pub15@synthora.com", "1100112233", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Supplier B
        supplierUserB = new User(UUID.randomUUID(), "Supplier B User", "supb_pub15@synthora.com", "2200112233", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Buyer
        buyerUser = new User(UUID.randomUUID(), "Buyer User", "buyer_pub15@synthora.com", "3300112233", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
    ...
    void test01_masterProductAppearsInPublicCatalog_whenApprovedOfferingExists() {
        ...
        var searchResult = masterProductService.searchActiveMasterProductsWithCriteria(
                new com.synthora.product.dto.MasterProductSearchCriteria("Paracetamol", null, null, null, null, null, null, null, null, null, null, null, null, null, null, 0, 10, null)
        );
    ...
    void test05_inactiveMasterProduct_doesNotAppearInPublicCatalog() {
        ...
        var searchResult = masterProductService.searchActiveMasterProductsWithCriteria(
                new com.synthora.product.dto.MasterProductSearchCriteria("Suspended", null, null, null, null, null, null, null, null, null, null, null, null, null, null, 0, 10, null)
        );
    ...
    void test09_legacyProduct_doesNotAutomaticallyPopulatePublicCatalog() {
        ...
        var searchResult = masterProductService.searchActiveMasterProductsWithCriteria(
                new com.synthora.product.dto.MasterProductSearchCriteria("Legacy Unmapped", null, null, null, null, null, null, null, null, null, null, null, null, null, null, 0, 10, null)
        );
