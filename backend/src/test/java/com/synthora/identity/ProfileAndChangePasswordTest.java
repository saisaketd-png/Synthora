...
public class ProfileAndChangePasswordTest {
    ...
    void setUp() {
        ...
        buyerUser.setEmail("buyer@synthora-test.com");
        ...
        supplierUser.setEmail("supplier@synthora-test.com");
        ...
        adminUser.setEmail("admin@synthora-test.com");
    ...
    void testGetProfile_allRoles() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/users/me")
                ...
                .andExpect(jsonPath("$.email").value("buyer@synthora-test.com"))
    ...
    void testUpdateProfile_success() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/users/me")
                ...
                .andExpect(jsonPath("$.email").value("buyer@synthora-test.com")); // email is unmodifiable
        ...
        assertThat(reloaded.getEmail()).isEqualTo("buyer@synthora-test.com");
    }
