...
import com.synthora.buyer.shortlist.BuyerShortlistService;
import com.synthora.buyer.shortlist.dto.AddShortlistItemRequest;
import com.synthora.buyer.shortlist.dto.BuyerShortlistResponse;
...
public class PhaseI810BuyerDecisionIntelligenceSecurityTest {
    ...
    void setUp() {
        ...
        // Admin
        adminUser = new User(UUID.randomUUID(), "Admin User", "admin_p810@synthora.com", "9988776655", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        // Buyer A
        buyerUserA = new User(UUID.randomUUID(), "Buyer Alpha", "buyer_a_p810@synthora.com", "1188776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        // Buyer B
        buyerUserB = new User(UUID.randomUUID(), "Buyer Beta", "buyer_b_p810@synthora.com", "2288776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        // Supplier A
        supplierUserA = new User(UUID.randomUUID(), "Supplier A User", "sup_a_p810@synthora.com", "3388776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
