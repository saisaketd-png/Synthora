...
public class PhaseI813MarketplaceQualitySecurityTest {
    ...
    void setUp() {
        ...
        adminUser = new User(UUID.randomUUID(), "Admin Quality User", "admin_p813@synthora.com", "9988776655", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        supplierUserA = new User(UUID.randomUUID(), "Supplier Quality A", "sup_a_p813@synthora.com", "3388776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        supplierUserB = new User(UUID.randomUUID(), "Unverified Supplier B", "sup_b_p813@synthora.com", "4488776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
    ...
    void test38_buyerCannotModifyCatalog() {
        User buyer = userRepository.save(new User(UUID.randomUUID(), "Buyer", "buyer_p813@synthora.com", "1122334455", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE));
