...
public class PhaseI812ProcurementWorkspaceSecurityTest {
    ...
    void setUp() {
        ...
        adminUser = new User(UUID.randomUUID(), "Admin User", "admin_p812@synthora.com", "9988776655", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        buyerUserA = new User(UUID.randomUUID(), "Buyer Alpha", "buyer_a_p812@synthora.com", "1188776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        buyerUserB = new User(UUID.randomUUID(), "Buyer Beta", "buyer_b_p812@synthora.com", "2288776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        supplierUserA = new User(UUID.randomUUID(), "Supplier A User", "sup_a_p812@synthora.com", "3388776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        supplierUserB = new User(UUID.randomUUID(), "Supplier B User", "sup_b_p812@synthora.com", "4488776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
