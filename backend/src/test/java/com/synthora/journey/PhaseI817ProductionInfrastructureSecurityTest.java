...
public class PhaseI817ProductionInfrastructureSecurityTest {
    ...
    void setUp() {
        ...
        adminUser = new User(UUID.randomUUID(), "Admin Infra User", "admin_p817@synthora.com", "9988776655", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        buyerUser = new User(UUID.randomUUID(), "Buyer Infra User", "buyer_p817@synthora.com", "1188776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
    ...
    void test01_productionProfileNoSecretsExposed() {
        assertThat(adminUser.getEmail()).isEqualTo("admin_p817@synthora.com");
    }
