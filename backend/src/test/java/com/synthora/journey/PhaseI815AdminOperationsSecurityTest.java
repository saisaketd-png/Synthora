...
import com.synthora.admin.operations.AdminOperationsController;
...
public class PhaseI815AdminOperationsSecurityTest {
    ...
    void setUp() {
        ...
        adminUser = new User(UUID.randomUUID(), "Admin Ops User", "admin_p815@synthora.com", "9988776655", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        buyerUser = new User(UUID.randomUUID(), "Buyer Ops User", "buyer_p815@synthora.com", "1188776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        supplierUser = new User(UUID.randomUUID(), "Supplier Ops User", "sup_p815@synthora.com", "3388776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
    ...
    void test30_notificationRecipientSecurityRemainsEnforced() {
        assertThat(adminUser.getEmail()).isEqualTo("admin_p815@synthora.com");
    }
}
