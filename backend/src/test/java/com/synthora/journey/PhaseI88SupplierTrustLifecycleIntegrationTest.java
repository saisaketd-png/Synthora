...
import com.synthora.seller.verification.*;
...
public class PhaseI88SupplierTrustLifecycleIntegrationTest {
    ...
    void setUp() {
        ...
        // Supplier A
        supplierUserA = new User(UUID.randomUUID(), "Supplier A User", "supa_phase88@synthora.com", "1100112233", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Supplier B
        supplierUserB = new User(UUID.randomUUID(), "Supplier B User", "supb_phase88@synthora.com", "2200112233", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Buyer
        buyerUser = new User(UUID.randomUUID(), "Buyer User", "buyer_phase88@synthora.com", "3300112233", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
