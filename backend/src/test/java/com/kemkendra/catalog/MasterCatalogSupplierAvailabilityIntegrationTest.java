...
public class MasterCatalogSupplierAvailabilityIntegrationTest {
    ...
    void setUp() {
        ...
        // Admin
        adminUser = new User(UUID.randomUUID(), "Admin", "admin_avail@kemkendra.com", "9900112233", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        // Supplier A (Verified)
        supplierUserA = new User(UUID.randomUUID(), "Supplier A", "supa_avail@kemkendra.com", "1100112233", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Supplier B (Verified)
        supplierUserB = new User(UUID.randomUUID(), "Supplier B", "supb_avail@kemkendra.com", "2200112233", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Supplier C (Verified)
        supplierUserC = new User(UUID.randomUUID(), "Supplier C", "supc_avail@kemkendra.com", "3300112233", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Buyer
        buyerUser = new User(UUID.randomUUID(), "Buyer User", "buyer_avail@kemkendra.com", "4400112233", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
