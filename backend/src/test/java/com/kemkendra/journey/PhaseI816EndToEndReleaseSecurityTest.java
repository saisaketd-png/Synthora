...
public class PhaseI816EndToEndReleaseSecurityTest {
    ...
    void setUp() {
        ...
        adminUser = new User(UUID.randomUUID(), "Admin Release User", "admin_p816@kemkendra.com", "9988776655", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        buyerUserA = new User(UUID.randomUUID(), "Buyer Alpha 816", "buyer_a_p816@kemkendra.com", "1188776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        buyerUserB = new User(UUID.randomUUID(), "Buyer Beta 816", "buyer_b_p816@kemkendra.com", "2288776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        supplierUserA = new User(UUID.randomUUID(), "Supplier A 816", "sup_a_p816@kemkendra.com", "3388776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        supplierUserB = new User(UUID.randomUUID(), "Supplier B 816", "sup_b_p816@kemkendra.com", "4488776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
    ...
    void test11_clientCannotSpoofIdentity() {
        assertThat(adminUser.getEmail()).isEqualTo("admin_p816@kemkendra.com");
    }
