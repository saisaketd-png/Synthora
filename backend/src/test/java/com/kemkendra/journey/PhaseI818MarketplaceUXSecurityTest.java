...
public class PhaseI818MarketplaceUXSecurityTest {
    ...
    void setUp() {
        ...
        adminUser = new User(UUID.randomUUID(), "Admin UX User", "admin_p818@kemkendra.com", "9988776655", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        buyerUser = new User(UUID.randomUUID(), "Buyer UX User", "buyer_p818@kemkendra.com", "1188776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        supplierUser = new User(UUID.randomUUID(), "Supplier UX User", "sup_p818@kemkendra.com", "3388776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
    ...
    void test10_buyerCannotSpoofIdentity() {
        assertThat(buyerUser.getEmail()).isEqualTo("buyer_p818@kemkendra.com");
    }
