...
public class PhaseI89OfferingGovernanceIntegrationTest {
    ...
    void setUp() {
        ...
        // Admin
        adminUser = new User(UUID.randomUUID(), "Admin Governance", "admin_phase89@kemkendra.com", "9900112244", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        // Supplier A
        supplierUserA = new User(UUID.randomUUID(), "Supplier A User", "supa_phase89@kemkendra.com", "1100112244", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Supplier B
        supplierUserB = new User(UUID.randomUUID(), "Supplier B User", "supb_phase89@kemkendra.com", "2200112244", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Buyer
        buyerUser = new User(UUID.randomUUID(), "Buyer User", "buyer_phase89@kemkendra.com", "3300112244", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
