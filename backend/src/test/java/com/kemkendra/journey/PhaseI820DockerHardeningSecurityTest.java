...
public class PhaseI820DockerHardeningSecurityTest {
    ...
    void setUp() {
        ...
        adminUser = new User(UUID.randomUUID(), "Admin Docker Hardening", "admin_p820@kemkendra.com", "9988776655", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        buyerUser = new User(UUID.randomUUID(), "Buyer Docker Hardening", "buyer_p820@kemkendra.com", "1188776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        supplierUser = new User(UUID.randomUUID(), "Supplier Docker Hardening", "sup_p820@kemkendra.com", "3388776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
    ...
    void test04_nonRootContainerUserConfiguration() {
        assertThat(adminUser.getEmail()).isEqualTo("admin_p820@kemkendra.com");
    }
