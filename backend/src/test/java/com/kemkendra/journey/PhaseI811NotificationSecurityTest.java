...
import com.kemkendra.notification.api.NotificationController;
...
public class PhaseI811NotificationSecurityTest {
    ...
    void setUp() {
        ...
        // Admin
        adminUser = new User(UUID.randomUUID(), "Admin User", "admin_p811@kemkendra.com", "9988776655", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        // Buyer A
        buyerUserA = new User(UUID.randomUUID(), "Buyer Alpha", "buyer_a_p811@kemkendra.com", "1188776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        // Buyer B
        buyerUserB = new User(UUID.randomUUID(), "Buyer Beta", "buyer_b_p811@kemkendra.com", "2288776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        // Supplier A
        supplierUserA = new User(UUID.randomUUID(), "Supplier A User", "sup_a_p811@kemkendra.com", "3388776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Supplier B
        supplierUserB = new User(UUID.randomUUID(), "Supplier B User", "sup_b_p811@kemkendra.com", "4488776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
