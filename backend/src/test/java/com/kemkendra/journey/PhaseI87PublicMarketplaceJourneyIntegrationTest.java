...
public class PhaseI87PublicMarketplaceJourneyIntegrationTest {
    ...
    void setUp() {
        ...
        // Admin
        adminUser = new User(UUID.randomUUID(), "Admin", "admin_phase87@kemkendra.com", "9900112233", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        // Supplier A
        supplierUserA = new User(UUID.randomUUID(), "Supplier A User", "supa_phase87@kemkendra.com", "1100112233", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Supplier B
        supplierUserB = new User(UUID.randomUUID(), "Supplier B User", "supb_phase87@kemkendra.com", "2200112233", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        // Buyer
        buyerUser = new User(UUID.randomUUID(), "Buyer User", "buyer_phase87@kemkendra.com", "3300112233", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
    ...
    void test22_and_23_poSnapshotRemainsImmutable_whenSupplierOfferingUpdated() {
        ...
        supplierOfferingService.updateOffering(offA.id(), new com.kemkendra.product.dto.UpdateSupplierOfferingRequest(new BigDecimal("150.00"), "INR", 500, new BigDecimal("99.80"), "USP", new BigDecimal("25.00"), "Drum", 7, true, true, true, "AVAILABLE"), supplierAuthA);
