...
public class PhaseI819DockerIntegrationSecurityTest {
    ...
    void setUp() {
        ...
        adminUser = new User(UUID.randomUUID(), "Admin Docker User", "admin_p819@kemkendra.com", "9988776655", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        buyerUser = new User(UUID.randomUUID(), "Buyer Docker User", "buyer_p819@kemkendra.com", "1188776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        supplierUser = new User(UUID.randomUUID(), "Supplier Docker User", "sup_p819@kemkendra.com", "3388776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
    ...
    void test20_requestCorrelationBehavior() {
        assertThat(adminUser.getEmail()).isEqualTo("admin_p819@kemkendra.com");
    }
}
