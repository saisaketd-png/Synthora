...
public class PhaseI814ProductionReadinessSecurityTest {
    ...
    void setUp() {
        ...
        adminUser = new User(UUID.randomUUID(), "Admin Readiness User", "admin_p814@kemkendra.com", "9988776655", "$2a$10$hash", UserRole.ADMIN, UserStatus.ACTIVE);
        ...
        buyerUserA = new User(UUID.randomUUID(), "Buyer Alpha 814", "buyer_a_p814@kemkendra.com", "1188776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        buyerUserB = new User(UUID.randomUUID(), "Buyer Beta 814", "buyer_b_p814@kemkendra.com", "2288776655", "$2a$10$hash", UserRole.USER, UserStatus.ACTIVE);
        ...
        supplierUserA = new User(UUID.randomUUID(), "Supplier A 814", "sup_a_p814@kemkendra.com", "3388776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
        ...
        supplierUserB = new User(UUID.randomUUID(), "Supplier B 814", "sup_b_p814@kemkendra.com", "4488776655", "$2a$10$hash", UserRole.SUPPLIER, UserStatus.ACTIVE);
