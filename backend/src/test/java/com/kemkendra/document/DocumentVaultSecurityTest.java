...
public class DocumentVaultSecurityTest {
    ...
    public void setUp() {
        ...
        adminUser.setEmail("admin_doc_" + suffix + "@kemkendra.com");
        ...
        supplierUserA.setEmail("sup_a_doc_" + suffix + "@kemkendra.com");
        ...
        supplierUserB.setEmail("sup_b_doc_" + suffix + "@kemkendra.com");
        ...
        buyerUser.setEmail("buyer_doc_" + suffix + "@kemkendra.com");
