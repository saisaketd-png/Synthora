...
import com.kemkendra.notification.email.EmailServiceImpl;
...
public class EmailNotificationServiceTest {
    ...
    public void testTemplateResolver_AllNotificationTypes_GenerateValidSubjectsAndCtas() {
        NotificationEmailTemplateResolver resolver = new NotificationEmailTemplateResolver("https://marketplace.kemkendra.com");
        ...
        for (NotificationType type : NotificationType.values()) {
            ...
            assertTrue(ctaUrl.startsWith("https://marketplace.kemkendra.com/dashboard/orders/"));
    ...
    public void testTemplateResolver_CtaUrlCannotBeRedirectedToExternalDomain() {
        ...
        String ctaUrl = resolver.resolveCtaUrl(n);
        assertEquals("https://app.kemkendra.com/dashboard/rfqs/" + entityId, ctaUrl);
        assertTrue(ctaUrl.startsWith("https://app.kemkendra.com/"));
    }
    ...
    public void testEmailServiceImpl_SuccessfulSend() throws Exception {
        ...
        EmailServiceImpl emailService = new EmailServiceImpl(
                mailSender,
                "notifications@kemkendra.com",
                "KemKendra B2B Marketplace",
                true
        );
