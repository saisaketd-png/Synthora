...
public class EmailServiceProductionHardeningTest {
    ...
    private static final String FROM_EMAIL = "notifications@kemkendra.com";
    private static final String FROM_NAME = "KemKendra B2B Marketplace";
    ...
    @Test
    @DisplayName("sendHtmlEmail skips dispatch when mail is disabled via kemkendra.mail.enabled=false")
