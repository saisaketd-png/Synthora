...
import com.kemkendra.identity.dto.*;
 ...
 * Validates the complete KemKendra workflow under production-like security and constraints:
...
class LocalProductionEndToEndValidationTest {
    ...
    void testBuyerRegistrationTermsEnforcement() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/auth/register")
                ...
                .andExpect(jsonPath("$.email", is("buyer.valid@kemkendra.com")))
                .andExpect(jsonPath("$.role", is("USER")));

        User user = userRepository.findByEmail("buyer.valid@kemkendra.com").orElseThrow();
    ...
    void testEmailVerificationLifecycle() throws Exception {
        ...
        unverifiedUser.setEmail("unverified.e2e@kemkendra.com");
        ...
        LoginRequest loginRequest = new LoginRequest("unverified.e2e@kemkendra.com", "Password123!");
        ...
        assertEquals("unverified.e2e@kemkendra.com", jwtService.extractEmail(token));
    }
    ...
    void testProfileSettingsAndChangePassword() throws Exception {
        ...
        user.setEmail("profile.test@kemkendra.com");
        ...
        mockMvc.perform(get("/api/v1/users/me")
                ...
                .andExpect(jsonPath("$.email", is("profile.test@kemkendra.com")));
        ...
        mockMvc.perform(post("/api/v1/auth/login")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(new LoginRequest("profile.test@kemkendra.com", "CurrentPassword123!"))))
                .andExpect(status().isBadRequest());

        mockMvc.perform(post("/api/v1/auth/login")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(new LoginRequest("profile.test@kemkendra.com", "NewPassword123!"))))
                .andExpect(status().isOk());
    }
    ...
    void testMarketplaceProcurementLifecycle() throws Exception {
        ...
        buyer.setEmail("buyer.mkt@kemkendra.com");
        ...
        supplierUser.setEmail("supplier.mkt@kemkendra.com");
    ...
    @Autowired
    private com.kemkendra.product.ProductRepository productRepository;
    ...
    void testDocumentVaultSecurity() throws Exception {
        ...
        user.setEmail("doc.user@kemkendra.com");
        ...
        com.kemkendra.product.Product product = new com.kemkendra.product.Product();
    ...
    void testRateLimitingE2E() throws Exception {
        ...
        LoginRequest req = new LoginRequest("throttled@kemkendra.com", "BadPass");
