...
public class AuditServiceSecurityTest {
    ...
    public void setup() {
        ...
        adminUser = new User();
        adminUser.setEmail("superadmin@kemkendra.com");
    ...
    public void testAuditService_UnknownEmailRejected() {
        Authentication ghostAuth = new UsernamePasswordAuthenticationToken("ghost@kemkendra.com", null, List.of(new SimpleGrantedAuthority("ROLE_ADMIN")));
