...
public class AdminAuditSecurityTest {
    ...
    public void setup() {
        ...
        adminUser = new User();
        adminUser.setEmail("audit-admin@kemkendra.com");
        ...
        regularBuyer.setEmail("audit-buyer@kemkendra.com");
        ...
        regularSupplier.setEmail("audit-supplier@kemkendra.com");
    ...
    public void testAuditRecording_DerivesActorFromSecurityContext() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/admin/audit")
                ...
                .andExpect(jsonPath("$.content[0].adminEmail", is("audit-admin@kemkendra.com")))
