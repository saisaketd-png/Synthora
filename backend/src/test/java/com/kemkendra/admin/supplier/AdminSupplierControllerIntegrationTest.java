...
import com.kemkendra.admin.supplier.dto.UpdateSupplierExportReadyRequest;
import com.kemkendra.admin.supplier.dto.UpdateSupplierStatusRequest;
import com.kemkendra.admin.supplier.dto.UpdateSupplierVerificationRequest;
...
public class AdminSupplierControllerIntegrationTest {
    ...
    public void setup() {
        ...
        adminUser.setEmail("admin1@kemkendra.com");
