...
class AdminAnalyticsIntegrationTest {
    ...
    void setUp() {
        ...
        adminUser.setEmail("admin.analytics@kemkendra.com");
        ...
        buyerUser.setEmail("buyer.analytics@kemkendra.com");
        ...
        supplierUser.setEmail("supplier.analytics@kemkendra.com");
