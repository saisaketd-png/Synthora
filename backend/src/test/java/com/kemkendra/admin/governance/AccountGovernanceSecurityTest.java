...
import com.kemkendra.admin.governance.dto.AdminAppealActionRequest;
import com.kemkendra.admin.governance.dto.AdminRequestInfoRequest;
import com.kemkendra.admin.governance.dto.ReinstateUserRequest;
import com.kemkendra.admin.governance.dto.SuspendUserRequest;
...
public class AccountGovernanceSecurityTest {
    ...
    public void test03_adminCannotSuspendAdmin() throws Exception {
        ...
        anotherAdmin.setEmail("admin2@kemkendra.com");
    ...
    public void test20_userCanRespondToInformationRequest() throws Exception {
        ...
        AppealResponseRequest request = new AppealResponseRequest("I have emailed the trade license to compliance@kemkendra.com");
        ...
        mockMvc.perform(post("/api/v1/account/appeals/" + appeal.getId() + "/response")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status").value("UNDER_REVIEW"))
                .andExpect(jsonPath("$.userResponse").value("I have emailed the trade license to compliance@kemkendra.com"));
    }
