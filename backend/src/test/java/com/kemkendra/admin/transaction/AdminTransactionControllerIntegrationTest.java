...
import com.kemkendra.admin.transaction.dto.CancelAdminPurchaseOrderRequest;
import com.kemkendra.admin.transaction.dto.UpdateAdminRfqStatusRequest;
...
public class AdminTransactionControllerIntegrationTest {
    ...
    @Autowired
    private com.kemkendra.product.MasterProductRepository masterProductRepository;

    @Autowired
    private com.kemkendra.product.SupplierOfferingRepository supplierOfferingRepository;
    ...
    public void setup() {
        ...
        adminUser.setEmail("admin.tx.api@kemkendra.com");
    ...
    public void testGetRfqs_WithMasterProductAndNullProductId_DoesNotReturn500() throws Exception {
        com.kemkendra.product.MasterProduct mp = new com.kemkendra.product.MasterProduct();
    ...
    public void testGetRfqs_WithNullProductAndNullSupplier_ReturnsSafeFallback() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/admin/transactions/rfqs/" + fallbackRfq.getId())
                        .header("Authorization", "Bearer " + adminToken))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.productName").value("Specialty Chemical Compound"));
    }
