...
public class AdminCatalogOperationsSecurityTest {
    ...
    public void setUp() {
        ...
        adminUser.setEmail("admin_gov_" + suffix + "@kemkendra.com");
        ...
        buyerUser.setEmail("buyer_gov_" + suffix + "@kemkendra.com");
        ...
        supplierUserA.setEmail("sup_a_gov_" + suffix + "@kemkendra.com");
        ...
        supplierUserB.setEmail("sup_b_gov_" + suffix + "@kemkendra.com");
