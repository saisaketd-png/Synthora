...
public class MultiSupplierRfqSecurityTest {
    ...
    public void setUp() {
        ...
        buyerUser.setEmail("buyer_src_" + suffix + "@kemkendra.com");
        ...
        supplierUserA.setEmail("sup_a_src_" + suffix + "@kemkendra.com");
        ...
        supplierUserB.setEmail("sup_b_src_" + suffix + "@kemkendra.com");
    ...
    public void test18_PoSnapshotIsImmutable() {
        ...
        com.kemkendra.order.dto.PurchaseOrderResponse poRes = purchaseOrderService.createPurchaseOrder(new com.kemkendra.order.dto.CreatePurchaseOrderRequest(rfq.id(), "123 Shipping St", "billing@buyer.com", "Note"), buyerAuth);
        assertNotNull(poRes);
