...
public class RoleCorrectRfqUxTest {
    ...
    void setUp() {
        ...
        supplierUser = new User(
                UUID.randomUUID(),
                "Supplier User",
                "supplier_rfq_role@kemkendra.com",
                "8881112222",
                "$2a$10$hashedpassword",
                UserRole.SUPPLIER,
                UserStatus.ACTIVE
    ...
    void buyerCanCreateRfqFromApprovedOffering_andSupplierReceivesRfq() {
        ...
        var authAdmin = new UsernamePasswordAuthenticationToken("admin@kemkendra.com", null, List.of(new SimpleGrantedAuthority("ROLE_ADMIN")));
