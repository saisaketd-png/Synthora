...
import com.kemkendra.rfq.sourcing.SourcingRequest;
import com.kemkendra.rfq.sourcing.SourcingRequestRepository;
...
public class MultiSupplierRfqHardeningSecurityTest {
    ...
    public void setUp() {
        ...
        buyerUser.setEmail("buyer_hrd_" + suffix + "@kemkendra.com");
        ...
        supplierUserA.setEmail("sup_a_hrd_" + suffix + "@kemkendra.com");
        ...
        supplierUserB.setEmail("sup_b_hrd_" + suffix + "@kemkendra.com");
