...
public class PurchaseOrderFulfillmentApiControllerTest {
    ...
    public void setup() {
        ...
        buyerA = createUser("buyerA@kemkendra.com", UserRole.USER);
        buyerAToken = jwtService.generateToken(buyerA);

        buyerB = createUser("buyerB@kemkendra.com", UserRole.USER);
        buyerBToken = jwtService.generateToken(buyerB);

        supplierUserA = createUser("supplierA@kemkendra.com", UserRole.SUPPLIER);
        supplierAToken = jwtService.generateToken(supplierUserA);
        supplierA = createSupplier(supplierUserA);

        supplierUserB = createUser("supplierB@kemkendra.com", UserRole.SUPPLIER);
