...
import com.kemkendra.admin.supplier.api.AdminSupplierController;
import com.kemkendra.admin.supplier.dto.AdminSupplierResponse;
import com.kemkendra.document.*;
...
import com.kemkendra.product.apis.SupplierOfferingController;
...
public class CatalogIntegrationStabilizationSecurityTest {
    ...
    @Autowired
    private com.kemkendra.admin.user.api.AdminUserController adminUserController;
    ...
    @Autowired
    private com.kemkendra.admin.audit.AuditLogRepository auditLogRepository;

    @Autowired
    private AdminSupplierService adminSupplierService;

    @Autowired
    private com.kemkendra.product.verification.SupplierOfferingVerificationService supplierOfferingVerificationService;
    ...
    public void setUp() {
        ...
        adminUser.setEmail("admin_stab_" + suffix + "@kemkendra.com");
        ...
        supplierUserA.setEmail("sup_a_stab_" + suffix + "@kemkendra.com");
        ...
        supplierA.setVerificationStatus(com.kemkendra.seller.SupplierVerificationStatus.VERIFIED);
        ...
        supplierUserB.setEmail("sup_b_stab_" + suffix + "@kemkendra.com");
        ...
        supplierB.setVerificationStatus(com.kemkendra.seller.SupplierVerificationStatus.VERIFIED);
    ...
    public void test10_AdminUserManagementContractAndSecurity() {
        ...
        // Fetch users page
        ResponseEntity<Page<com.kemkendra.admin.user.dto.AdminUserResponse>> res = adminUserController.getUsers(
        ...
        // Filter by Role
        ResponseEntity<Page<com.kemkendra.admin.user.dto.AdminUserResponse>> adminOnly = adminUserController.getUsers(
    ...
    public void test13_ProductRequestLinkingSecurityAndValidation() {
        ...
        assertThrows(com.kemkendra.common.ResourceNotFoundException.class, () ->
    ...
    public void test15_AdminOfferingModerationWorkflowAndAudit() {
        ...
        com.kemkendra.product.verification.dto.SupplierOfferingGovernanceWorkspaceDto ws =
        ...
        var auditLogs = auditLogRepository.findAll().stream()
                .filter(a -> com.kemkendra.admin.audit.AuditTargetType.SUPPLIER_OFFERING.equals(a.getTargetType()) &&
                        createdOffering.id().toString().equals(a.getTargetId()))
                .toList();
        assertFalse(auditLogs.isEmpty());
        assertTrue(auditLogs.stream().anyMatch(a -> com.kemkendra.admin.audit.AuditAction.SUPPLIER_OFFERING_APPROVED.equals(a.getAction())));
    }
    ...
    public void test17_AlreadyVerifiedSupplierCannotBeReVerified() {
        ...
        assertEquals(com.kemkendra.seller.SupplierVerificationStatus.VERIFIED, supplierA.getVerificationStatus());
        ...
        assertThrows(IllegalArgumentException.class, () ->
                adminSupplierService.transitionSupplierVerification(
                        supplierA.getId(),
                        com.kemkendra.seller.SupplierVerificationStatus.VERIFIED,
