package com.kemkendra.supplier;
...
import com.kemkendra.product.apis.SupplierPublicController;
import com.kemkendra.product.dto.CreateMasterProductRequest;
import com.kemkendra.product.dto.CreateSupplierOfferingRequest;
import com.kemkendra.product.dto.MasterProductDetailResponse;
import com.kemkendra.product.dto.SupplierOfferingResponse;
import com.kemkendra.seller.SupplierProfileController;
...
import com.kemkendra.seller.verification.AdminSupplierVerificationController;
import com.kemkendra.seller.verification.SupplierVerificationService;
...
public class SupplierOnboardingAndVerificationSecurityTest {
    ...
    @Autowired
    private com.kemkendra.product.apis.PublicMasterCatalogController publicMasterCatalogController;
    ...
    void setUp() {
        ...
        adminUser.setEmail("admin-onboarding-" + UUID.randomUUID() + "@kemkendra.com");
    ...
    void test08_AdminVerificationLifecycleWorkflow() {
        ...
        ResponseEntity<SupplierVerificationWorkspaceDto> reqInfoRes = adminSupplierVerificationController.requestInformation(
                supplierA.getId(),
                new com.kemkendra.seller.verification.dto.RequestInfoRequest("Please upload ISO-9001 certification and recent GST-3B filing"),
                adminAuth
        );
        ...
        ResponseEntity<SupplierVerificationWorkspaceDto> verifyRes = adminSupplierVerificationController.finalizeVerification(
                supplierA.getId(),
                new com.kemkendra.seller.verification.dto.FinalizeVerificationRequest("Verified company identity, tax filings and drug manufacturing license."),
                adminAuth
        );
    ...
    void test09_AdminVerificationPreventsDuplicateTransitionsOnVerifiedSupplier() {
        ...
        assertThrows(IllegalStateException.class, () ->
                adminSupplierVerificationController.finalizeVerification(
                        supplierA.getId(),
                        new com.kemkendra.seller.verification.dto.FinalizeVerificationRequest("Duplicate verify"),
                        adminAuth
                ));
    }
    ...
    void test11_AdminCanRejectSupplierWithReason() {
        ...
        ResponseEntity<SupplierVerificationWorkspaceDto> rejectRes = adminSupplierVerificationController.rejectSupplier(
                supplierB.getId(),
                new com.kemkendra.seller.verification.dto.RejectSupplierRequest("Invalid tax registration certificate provided."),
                adminAuth
        );
    ...
    void test12_AdminCanSuspendSupplierAccount() {
        ...
        ResponseEntity<SupplierVerificationWorkspaceDto> suspendRes = adminSupplierVerificationController.suspendSupplier(
                supplierA.getId(),
                new com.kemkendra.seller.verification.dto.SuspendSupplierRequest("Compliance violation detected."),
                adminAuth
        );
