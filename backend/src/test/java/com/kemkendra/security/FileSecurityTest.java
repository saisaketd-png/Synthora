...
public class FileSecurityTest {
    ...
    public void setup() {
        ...
        // Buyers
        buyerA = createTestUser("buyer_a_filesec@kemkendra.com", "Buyer A", UserRole.USER);
        tokenBuyerA = jwtService.generateToken(buyerA);

        buyerB = createTestUser("buyer_b_filesec@kemkendra.com", "Buyer B", UserRole.USER);
        tokenBuyerB = jwtService.generateToken(buyerB);

        // Suppliers
        supplierUserA = createTestUser("supplier_a_filesec@kemkendra.com", "Supplier User A", UserRole.SUPPLIER);
        ...
        supplierUserB = createTestUser("supplier_b_filesec@kemkendra.com", "Supplier User B", UserRole.SUPPLIER);
        ...
        // Admin
        adminUser = createTestUser("admin_filesec@kemkendra.com", "Admin Security", UserRole.ADMIN);
