...
import com.kemkendra.product.ProductSupplier;
import com.kemkendra.product.ProductSupplierRepository;
...
public class AuthorizationIdorSecurityTest {
    ...
    public void setup() {
        ...
        // 1. Buyers
        buyerA = createTestUser("buyer_a@kemkendra.com", "Buyer A", UserRole.USER);
        tokenBuyerA = jwtService.generateToken(buyerA);

        buyerB = createTestUser("buyer_b@kemkendra.com", "Buyer B", UserRole.USER);
        tokenBuyerB = jwtService.generateToken(buyerB);

        // 2. Suppliers
        supplierUserA = createTestUser("supplier_a@kemkendra.com", "Supplier User A", UserRole.SUPPLIER);
        ...
        supplierUserB = createTestUser("supplier_b@kemkendra.com", "Supplier User B", UserRole.SUPPLIER);
        ...
        // 3. Admin
        adminUser = createTestUser("admin@kemkendra.com", "Admin User", UserRole.ADMIN);
    ...
    public void testBuyerCannotAccessOtherBuyerPurchaseOrder() throws Exception {
        ...
        poB.setBillingContact("buyer_b@kemkendra.com");
    ...
    public void testSupplierCannotAccessOtherSupplierPo() throws Exception {
        ...
        poB.setBillingContact("buyer_a@kemkendra.com");
        poB.setStatus(OrderStatus.PLACED);
        poB.setPlacedAt(LocalDateTime.now());
        poB = purchaseOrderRepository.save(poB);
    ...
    public void testBuyerCannotCreatePoOnUnacceptedRfq() throws Exception {
        ...
        CreatePurchaseOrderRequest poReq = new CreatePurchaseOrderRequest(
                rfqA.getId(), "123 Shipping St", "buyer_a@kemkendra.com", "Urgent delivery"
        );
    ...
    public void testBuyerCannotShipPurchaseOrder() throws Exception {
        ...
        po.setBillingContact("buyer_a@kemkendra.com");
