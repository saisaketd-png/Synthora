...
public class InputValidationSecurityTest {
    ...
    @Autowired
    private com.kemkendra.rfq.quotation.QuotationRepository quotationRepository;
    ...
    public void setup() {
        ...
        // Buyer
        buyer = createTestUser("buyer_validation@kemkendra.com", "Validation Buyer", UserRole.USER);
        tokenBuyer = jwtService.generateToken(buyer);

        // Supplier
        supplierUser = createTestUser("supplier_validation@kemkendra.com", "Validation Supplier", UserRole.SUPPLIER);
        ...
        // Admin
        adminUser = createTestUser("admin_validation@kemkendra.com", "Validation Admin", UserRole.ADMIN);
    ...
    public void testScriptInRejectionReason() throws Exception {
        ...
        com.kemkendra.rfq.quotation.Quotation q = new com.kemkendra.rfq.quotation.Quotation();
        q.setRfq(rfq);
    ...
    public void testMassAssignmentRoleInRegistration() throws Exception {
        ...
        User registered = userRepository.findByEmail("hacker@kemkendra.com").orElseThrow();
