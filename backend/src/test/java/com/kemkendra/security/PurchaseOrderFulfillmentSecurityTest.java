...
public class PurchaseOrderFulfillmentSecurityTest {
    ...
    public void setup() {
        ...
        // Buyers
        buyerA = createTestUser("buyer_a_po@kemkendra.com", "Buyer A", UserRole.USER);
        tokenBuyerA = jwtService.generateToken(buyerA);

        buyerB = createTestUser("buyer_b_po@kemkendra.com", "Buyer B", UserRole.USER);
        tokenBuyerB = jwtService.generateToken(buyerB);

        // Suppliers
        supplierUserA = createTestUser("supplier_a_po@kemkendra.com", "Supplier User A", UserRole.SUPPLIER);
        ...
        supplierUserB = createTestUser("supplier_b_po@kemkendra.com", "Supplier User B", UserRole.SUPPLIER);
