---
name: kemkendra-development
description: Project-specific architectural rules, authorization constraints, and development guidelines for the KemKendra B2B marketplace.
---

# KemKendra Development Rules
